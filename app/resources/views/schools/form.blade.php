...
<div class="mt-6 max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
    ...
    <p class="mt-2 text-slate-600">{{ $school ? 'Correct identity and optional details. Dated enrolment and participation history cannot be changed here.' : 'A permanent internal code starting at AN-001 is assigned when you save.' }}</p>
